...
abstract class DataChannelManager<ViewState> {
    ...
    fun launchJob(
        ...
        logD(TAG, "launchJob Executed. ${stateEvent.eventName()}")
        ...
        if(canExecuteNewStateEvent(stateEvent)){
            ...
            logD(TAG, "launchJob NOT Executed. ${stateEvent.eventName()}")
